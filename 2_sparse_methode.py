...
# Sparse NMF : Réduction de dimensions avec parcimonie
nmf_model = NMF(n_components=2, init='random', random_state=42, l1_ratio=0.5)  # Ajout de la contrainte de parcimonie
...
plt.title("Clustering via Sparse NNMF")
...
# Convertir les valeurs de 'Gender' en catégories (0 pour 'Male', 1 pour 'Female' si nécessaire)
